...
- **Spells**: A magic system that lets players cast offensive, defensive, or utility spells. Spells consume resources (like mana) and add strategic depth to combat.
- **Discoveries**: Secrets, or special events uncovered through interactions or while exploring. An unintrusive quest system.
- **Procedurally Generated Overworld**: A dynamic overworld map that is generated differently each playthrough. This ensures replayability, with new terrain, encounters, and exploration opportunities every time.
